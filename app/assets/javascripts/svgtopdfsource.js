var SVGtoPDF = function(doc, svg, x, y, options) {
    ...
    var SvgElem = function(obj, inherits) {
     ...
     //   console.log('line957:',key,'useCSS:',useCSS);
     ...
     //     console.log('cache[key] !== undefined');
        ...
        if (useCSS && key !== 'transform') { // the CSS transform behaves strangely
          if (!this.css) {
            this.css = obj.style;//getComputedStyle(obj);
      //      console.log(obj);
      //      console.log('!this.css', this.css);
          }
          value = this.css[keyInfo.css || key] || this.attr(key);
     //     console.log('useCSS && key !== \'transform\'', value);
     //     console.log('this.css = ', this.css);
        } else {
          value = this.attr(key);
      ...
      //    console.log('value === \'inherit\'', result);
          if (result != null) {
      ...
      //    console.log('keyInfo.values != null',result);
          if (result != null) {
    ...
    var SvgElemText = function(obj, inherits) {
      ...
      (function (textParentElem) {
        ...
        function recursive(currentElem, parentElem) {
          ...
          try {
            console.log("doc.font",fontNameorLink);
    ...
    options = options || {};
  //  console.log('for useCSS');
  //  console.log('SVGElement',(typeof SVGElement !== 'undefined'));
  //  console.log('svg instanceof',(svg instanceof SVGElement));
  //  console.log('SVGElement', SVGElement);
  //  console.log('typeof getComputed',(typeof getComputedStyle === 'function'));
    ...
    if (typeof fontCallback !== 'function') {
      fontCallback = function(family, bold, italic, fontOptions) {
        if (doc._registeredFonts[ family ]){
            return family;
        }
        else if (family.match(/(?:^|,)\s*serif\s*$/)) {
